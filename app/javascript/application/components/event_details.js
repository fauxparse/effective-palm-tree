...
class EventDetails extends React.Component {
          ...
          <div>
            ...
            <TabList selected={tab} onSwitch={this.switchTab.bind(this)}>
              ...
              <Tab name="availability">
                <svg width="24" height="24" viewBox="0 0 24 24"><g transform="translate(.5 .5)"><path d="M6 12l4 4 8-8"/><circle cx="12" cy="12" r="11"/></g></svg>
              </Tab>
              <Tab name="roles">
  ...
  contents() {
    ...
    if (tab == 'assignments') {
      return (
        <EventAssignments event={event} group={group} onChange={refreshEvent}/>
      )
